...
public class PersistentCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "in.illimitable.cookieprefs";
    private static final String COOKIE_DOMAINS_STORE = "in.illimitable.CookieStore.domain";
    private static final String COOKIE_DOMAIN_PREFIX = "in.illimitable.CookieStore.domain_";
    private static final String COOKIE_NAME_PREFIX = "in.illimitable.CookieStore.cookie_";
    ...
    public synchronized void add(URI uri, HttpCookie cookie) {
        ...
        for (HttpCookie httpCookie : cookies) {
            names.add(httpCookie.getName());
            prefsWriter.putString(COOKIE_NAME_PREFIX + uri + httpCookie.getName(),
                    encodeCookie(new PersistentCookie(httpCookie)));
        }
     ...
     */
    protected String encodeCookie(PersistentCookie cookie) {
        if (cookie == null)
            return null;
